        ...
        >
            ...
            >
                ...
                <div className="custom-scrollbar w-full max-h-[92vh] pb-3 overflow-y-auto rounded-2xl shadow-2xl
                    ...
                    {/* Image gallery */}
                    <div
                        className="relative w-full overflow-hidden rounded-t-3xl bg-black/10"
                    ...
                    <div className="p-6 space-y-5">
                        ...
                        {/* About */}
                        <div>
                            <h3 className="text-xs font-semibold uppercase tracking-widest mb-2 text-gray-400 dark:text-white/40">
                                About
                            </h3>
                            <p className="text-sm leading-relaxed font-light text-gray-700 dark:text-white/75">
                        ...
                        {/* Features */}
                        <div>
                            <h3 className="text-xs font-semibold uppercase tracking-widest mb-3 text-gray-400 dark:text-white/40">
                                Features
                            </h3>
                            <ul className="space-y-2">
                                {selectedProject.features.map((feat, i) => (
                                    <li key={i} className="flex items-start gap-2.5">
                                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full flex-shrink-0 bg-emerald-500/50" />
            ...
            <div className="py-20 flex items-center justify-center flex-col bg-gradient-to-tr from-[#101010] to-[#0A0A0A]" id="projects">
                <div className="text-center">
                    ...
                    <p className="text-sm mt-2 font-extralight text-white/80 text-center normal-text tracking-normal">
                        An array of projects that demonstrate my expertise in full-stack development.
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8 px-7 lg:px-4 max-w-6xl">
                    {projects.map((project, index) => (
                        <div
                            key={index}
                            onClick={() => openModal(project)}
                            className="p-4 rounded-2xl border border-white/10 normal-text bg-[#0b0b0b] space-y-4 pb-7
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap items-center gap-2 mt-3">
                                    <span className="text-xs text-white/80 bg-white/10 border border-white/5 px-3 py-1 rounded-full
                                    ...
                                    {project.langs.map((lang, i) => (
                                        <span
                                            key={i}
                                            className="text-xs text-white/80 bg-white/10 border border-white/5 px-3 py-1 rounded-full
                                                       hover:bg-emerald-500/10 hover:text-emerald-400 hover:border-emerald-500/20 transition-colors duration-200"
                                        >
                                            {lang}
                                        </span>
